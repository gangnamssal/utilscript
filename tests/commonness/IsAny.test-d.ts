...
type cases = [
  ...
  // 추가 엣지 케이스
  Expect<Equal<IsAny<{ a: any }>, false>>,
  Expect<Equal<IsAny<any & string>, true>>,
  Expect<Equal<IsAny<any | string>, true>>,
  Expect<Equal<IsAny<keyof any>, false>>,
  Expect<Equal<IsAny<Promise<any>>, false>>,
  Expect<Equal<IsAny<Map<any, string>>, false>>,
  Expect<Equal<IsAny<Set<any>>, false>>,
  Expect<Equal<IsAny<readonly any[]>, false>>,
  Expect<Equal<IsAny<[any, string]>, false>>,
  Expect<Equal<IsAny<Partial<any>>, false>>,
  Expect<Equal<IsAny<Required<any>>, false>>,
  Expect<Equal<IsAny<Readonly<any>>, false>>,
  Expect<Equal<IsAny<Record<any, string>>, false>>,
  Expect<Equal<IsAny<void>, false>>,
];
